...
from simulation.day12_governance import (
    build_day12_artifacts,
    can_perform_action,
...
def main() -> None:
    data = build_day12_artifacts(PROJECT_ROOT)
    failed: list[str] = []
    checks: list[tuple[str, bool]] = []
    client = TestClient(app)
    health = client.get("/health").json()
    endpoints = {
        "/api/simulation": "day12_paper_simulation_ready",
        "/api/reports": "day12_report_export_ready",
        "/api/licenses": "day2_license_registry_ready",
        "/api/admin": "day12_rbac_ready",
        "/api/audit": "day12_append_only_audit_ready",
    }
    ...
    checks.extend([
        ...
        ("health_day12", health["version"] in {"0.1.0-day12", "0.1.0-day13", "0.1.0-day14"} and health["modules"].get("simulation") == "day12_paper_simulation_governance_ready"),
    ])
    ...
    checks.append(("frontend_day12_copy", all(word in combined for word in ["Day12", "simulation_account", "export_manifest", "license_gate", "RBAC", "append_only"])))
    ...
    report: dict[str, Any] = {
        ...
        "artifacts": {
            ...
            "audit_log": "reports/day12/audit_log.json",
            "license_gate_report": "reports/day12/license_gate_report.json",
        },
    }
    out_path = PROJECT_ROOT / "reports" / "day12" / "acceptance_report.json"
