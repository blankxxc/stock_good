...
def run_acceptance() -> dict[str, Any]:
    ...
    leakage_path = ROOT / "reports" / "day3" / "leakage_report.json"
    synthetic_path = ROOT / "reports" / "day3" / "synthetic_mini_market_report.json"
    ...
    check("frontend_pages_day3_ready", "Day 3" in frontend_dq.read_text(encoding="utf-8") and "Day 3" in frontend_lineage.read_text(encoding="utf-8"))
    ...
    report_path = ROOT / "reports" / "day3" / "acceptance_report.json"
