...
def run_acceptance() -> dict[str, Any]:
    ...
    check("payload_status", payload["status"] == "day13_ops_deployment_ready", payload.get("status"))
    ...
    pipeline = subprocess.run([sys.executable, "scripts/run_day13_pipeline.py", "--dry-run"], cwd=ROOT, text=True, capture_output=True, timeout=180)
    ...
    check("ops_registry", "reports/day13/day13_ops_acceptance_report.json" in registry and "config_hash" in registry, None)
