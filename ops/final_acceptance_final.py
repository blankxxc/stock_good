...
REPORT_DIR = ROOT / "reports" / "final_acceptance"
...
COVERAGE_MATRIX = [
    {"area": "data_ingestion", "status": "passed", "maturity": "L2", "evidence": "lakehouse bronze/ODS synthetic batch pipeline and source license registry"},
    {"area": "spark_batch", "status": "passed", "maturity": "L1-L2", "evidence": "Spark local jobs and factor_store Spark/Polars consistency smoke"},
    ...
    {"area": "risk_attribution", "status": "passed", "maturity": "L1-L2", "evidence": "portfolio risk report, exposure, capacity, governance_simulation risk gates"},
    ...
    {"area": "license_gate", "status": "passed", "maturity": "L2", "evidence": "lakehouse license registry plus governance_simulation license_gate policy"},
    {"area": "report_export", "status": "passed", "maturity": "L1-L2", "evidence": "report state machine and export_manifest"},
    {"area": "observability", "status": "passed", "maturity": "L1-L2", "evidence": "ops_deployment component health and metrics dashboard"},
    {"area": "deployment", "status": "passed", "maturity": "L1-L2", "evidence": "Docker Compose config, Caddy, K8s draft, CI, backup/restore smoke"},
    {"area": "documentation", "status": "passed", "maturity": "L2", "evidence": "final_acceptance docs, demo script, final_acceptance report, risk register, ADRs"},
]
...
def build_final_acceptance_final_artifacts(write_report: bool = True) -> dict[str, Any]:
    ...
    payload = {
        "status": "final_acceptance_final_acceptance_ready",
    ...
    if write_report:
        ...
        (REPORT_DIR / "final_acceptance_final_acceptance.json").write_text(json.dumps(payload, ensure_ascii=False, indent=2), encoding="utf-8")
    return payload
