...
def advanced_models_report() -> dict[str, Any]:
    return _read_json(project_root() / "reports" / "advanced_models" / "advanced_model_integration_report.json")


def model_comparison_report() -> dict[str, Any]:
    return _read_json(project_root() / "reports" / "advanced_models" / "model_comparison_report.json")
...
def advanced_models_payload(research_boundary: str) -> dict[str, Any]:
    ...
    if report.get("status") != "ok":
        return {
            "module": "models",
            "status": "advanced_models_advanced_models_pending",
    ...
    return {
        "module": "models",
        "status": "advanced_models_advanced_models_ready",
...
def advanced_models_experiment_summary(research_boundary: str) -> dict[str, Any]:
    ...
    if payload.get("status") != "advanced_models_advanced_models_ready":
        return payload
    return {
        "status": "advanced_models_advanced_models_ready",
