...
def _read_candidate_positions(project_root: Path) -> pd.DataFrame:
    candidates = [
        project_root / "reports" / "research_loop" / "holdings.parquet",
...
def _build_simulation_tables(project_root: Path) -> dict[str, Any]:
    ...
    for idx, row in candidates.iterrows():
        ...
        positions.append({
            "account_id": "sim_acc_governance_simulation_research",
            "symbol": row["symbol"],
    ...
    account = {
        ...
        "cash": cash,
        "nav": nav[-1]["nav"],
        "run_id": "governance_simulation_simulation_run_v001",
        "model_version": "advanced_models_research_candidate_adapters_v001",
...
def build_governance_simulation_artifacts(project_root: str | Path | None = None) -> dict[str, Any]:
    ...
    audit_log = [
        {"audit_id": "audit_governance_simulation_submit_001", "actor": "alice", "role": "researcher", "action": "submit_report", "resource": "report_governance_simulation_001", "created_at": _now_iso(), "append_only": True, "trace_id": "trace_governance_simulation_submit"},
        {"audit_id": "audit_governance_simulation_review_001", "actor": "bob", "role": "reviewer", "action": "approve_report", "resource": "report_governance_simulation_001", "created_at": _now_iso(), "append_only": True, "trace_id": "trace_governance_simulation_review"},
        {"audit_id": "audit_governance_simulation_export_001", "actor": "carol", "role": "compliance", "action": "export_report", "resource": "report_governance_simulation_001", "created_at": _now_iso(), "append_only": True, "trace_id": "trace_governance_simulation_export"},
    ]
    ...
    export_manifest = {
        "export_id": "export_governance_simulation_001",
        "report_id": "report_governance_simulation_001",
        ...
        "data_versions": ["lakehouse_snapshot_manifest_v001", "research_loop_label_v001"],
        ...
        "audit_id": "audit_governance_simulation_export_001",
    }
    ...
    report_dir = project_root / "reports" / "governance_simulation"
    gold_dir = project_root / "data" / "gold"
    _write_json(report_dir / "governance_simulation_simulation_governance_report.json", payload)
