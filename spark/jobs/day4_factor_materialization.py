...
REPORT = ROOT / "reports" / "day4" / "spark_factor_materialization_report.json"
SOURCE = ROOT / "data" / "samples" / "synthetic_mini_market" / "day3_market_daily.parquet"
...
def run_job() -> dict[str, object]:
    spark = (
        ...
        .appName("stock-good-day4-spark-factor-materialization")
    ...
    try:
        ...
        report = {
            ...
            "job_name": "day4_spark_factor_materialization",
