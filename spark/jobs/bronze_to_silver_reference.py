...
REPORT = ROOT / "reports" / "lakehouse" / "spark_bronze_to_silver_reference_report.json"


def main() -> None:
    spark = SparkSession.builder.master("local[*]").appName("stock-good-lakehouse-reference-smoke").getOrCreate()
    try:
