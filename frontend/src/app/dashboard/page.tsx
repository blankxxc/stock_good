...
const config = getConsolePage('dashboard');
...
export default function Page() {
  return (
    ...
    <div className="card compatibility-checkpoints"><strong>验收兼容说明</strong><p>research_loop research_loop: /api/dashboard latest run model_version data_cutoff_time leakage_check_status.</p></div>
    </section>
  );
}
