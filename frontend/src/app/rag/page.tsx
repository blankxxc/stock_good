...
export default function Page() {
  return (
    ...
    <div className="card compatibility-checkpoints"><strong>验收兼容说明</strong><p>Day 10 RAG evidence: /api/rag claim_id as_of evidence_strength 无引用拒答 citation cards license gate.</p></div>
    </section>
  );
}
