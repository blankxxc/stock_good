...
export default function Page() {
  return (
    <section className="card artifact-backed" data-api-prefix="/api/">
      ...
      <div className="grid">
        <div className="card"><strong>lakehouse 兼容状态</strong><p>保留 not_authorized、restricted、adapter_pending 等 lakehouse license registry 语义，同时新增 governance_simulation license_gate。</p></div>
