...
export default function Page() {
  return (
    <section className="card artifact-backed" data-api-prefix="/api/">
      ...
      <div className="grid">
        <div className="card"><strong>Day12 append_only audit</strong><p>审计事件只追加不修改不删除，覆盖 submit_report、approve_report、export_report、license_gate 和 simulation action。</p></div>
