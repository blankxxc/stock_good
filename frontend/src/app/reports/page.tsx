...
export default function Page() {
  return (
    <section className="card artifact-backed" data-api-prefix="/api/">
      ...
      <div className="grid">
        <div className="card"><strong>governance_simulation 报告状态机</strong><p>draft → review → approved → exportable → exported → revoked，导出前检查 data_quality、leakage、license_gate、RAG citation 和 forbidden_wording。</p></div>
