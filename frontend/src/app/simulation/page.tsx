...
export default function Page() {
  return (
    <section className="card artifact-backed" data-api-prefix="/api/">
      ...
      <div className="grid">
        <div className="card"><strong>governance_simulation paper trading</strong><p>simulation_account、simulation_order、simulation_position、simulation_nav、simulation_risk 均来自 {config.apiPath} 与 reports/governance_simulation 产物；所有 order 均标记 simulated。</p></div>
