...
export default function Page() {
  return (
    ...
    <div className="card compatibility-checkpoints"><strong>验收兼容说明</strong><p>Day 5 LightGBM scores: /api/scores score rank percentile horizon model_version.</p></div>
    </section>
  );
}
