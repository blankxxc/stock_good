  ...
  return (
    <section className="page-grid">
      ...
      <div className="hero-card">
        <p className="eyebrow">Day13 · Ops readiness</p>
        <h1>配置、编排、回填、监控、部署与备份恢复</h1>
        <p>统一落地 Day13 运维闭环：prefect-local 单一编排器、resolved_config.yaml、config_hash、backfill dry-run、dataset_snapshot_manifest、CI/CD gates、Spark/Flink/Kafka/ClickHouse/PostgreSQL/Redis 可观测性和 backup/restore smoke。</p>
      </div>
      <div className="card-grid">
        ...
        <div className="card"><strong>backup/restore</strong><p>deploy/backup/backup_day13.sh --smoke 与 restore_day13.sh --smoke 生成 deterministic manifest。</p></div>
      </div>
      <div className="card"><strong>One-click dry-run</strong><p>命令：python scripts/run_day13_pipeline.py --dry-run；API：/api/ops、/api/orchestration、/api/backfill、/api/observability、/api/deployment。</p></div>
